...
public class TwoPair : ICardCombination
{
    public CombinationName Name { get; } = CombinationName.TwoPair;
    ...
    public bool Check(IEnumerable<Card> cards)
    {
        ...
        var pairCount = cardCountDict.Values.Count(cardCount => cardCount >= 2);
        return pairCount == 2;
    }
}